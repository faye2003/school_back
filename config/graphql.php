...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                // ExampleQuery::class,
                App\GraphQL\Queries\EleveQuery::class,
                App\GraphQL\Queries\ProfesseurQuery::class,
                App\GraphQL\Queries\ClasseQuery::class,
                App\GraphQL\Queries\CourQuery::class,
                App\GraphQL\Queries\CycleQuery::class,
                App\GraphQL\Queries\DisciplineQuery::class,
                App\GraphQL\Queries\EmploiQuery::class,
                App\GraphQL\Queries\EvaluationQuery::class,
                App\GraphQL\Queries\InscriptionQuery::class,
                App\GraphQL\Queries\OptionQuery::class,
    ...
    'types' => [
        ...
        'Eleve' => App\GraphQL\Types\EleveType::class,
        'Professeur' => App\GraphQL\Types\ProfesseurType::class,
        'Classe' => App\GraphQL\Types\ClasseType::class,
        'Cours' => App\GraphQL\Types\CourType::class,
        'Cycle' => App\GraphQL\Types\CycleType::class,
        'Discipline' => App\GraphQL\Types\DisciplineType::class,
        'Emploi' => App\GraphQL\Types\EmploiType::class,
        'Inscription' => App\GraphQL\Types\InscriptionType::class,
        'Evaluation' => App\GraphQL\Types\EvaluationType::class,
